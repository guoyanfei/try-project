package com.guo.code.tls.tls_sigature;
...
public class tls_sigature {
    ...
    public static void main(String[] args) {
        try {
            ...
            String privStr = "-----BEGIN PRIVATE KEY-----\n" + "MIGEAgEAMBAGByqGSM49AgEGBSuBBAAKBG0wawIBAQQgt1D+C5Szwigjkn0nBOdw\n" + "BocpYVVF1o4bOJ5p015ccC+hRANCAASm64MKVRUOZyOD7Pau4UCdjwVFBqW09how\n" + "K1uULSgPIyIFUS+sFkW5Eqi3WcJKCS2nYAfpOru2sAmzoTwcGMMT\n" + "-----END PRIVATE KEY-----\n";

            //change public pem string to public string
            String pubStr = "-----BEGIN PUBLIC KEY-----\n" + "MFYwEAYHKoZIzj0CAQYFK4EEAAoDQgAEpuuDClUVDmcjg+z2ruFAnY8FRQaltPYa\n" + "MCtblC0oDyMiBVEvrBZFuRKot1nCSgktp2AH6Tq7trAJs6E8HBjDEw==\n" + "-----END PUBLIC KEY-----\n";

            // generate signature
            GenTLSSignatureResult result = GenTLSSignatureEx(1400045640, "xiassssojun", privStr);
            ...
            // check signature
            CheckTLSSignatureResult checkResult = CheckTLSSignatureEx(sig, 1400045640, "xiassssojun", pubStr);
